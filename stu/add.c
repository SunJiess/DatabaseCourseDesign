...
int cgiMain()
{
	...
	strcpy(sql, "create table information(id int not null primary key, name varchar(20) not null, age int not null, sex varchar(10) not null,dept varchar(20) not null )");
